 ...
 *
 *IMPORTANT NOTE: I did not know whether to use a switch like the lab manual said or to use a button
 * like the video demonstration showed, so I followed the video, that way I could make sure I was
 * doing it correctly
 *
 *
 *
...
int main(void) {
    ...
    const unsigned long S_period = 2;
